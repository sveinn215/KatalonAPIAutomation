...
response = WS.sendRequest(findTestObject('Booking/createBooking', [('firstname') : "\"${firstName}\"", ('lastname') : lastName, ('totalprice') : totalPrice
            , ('depositpaid') : true, ('checkin') : checkIn, ('checkout') : checkOut, ('additionalneeds') : additionalNeeds]))
...
assert responseBody.bookingid != null

GlobalVariable.bookingId = responseBody.bookingid
